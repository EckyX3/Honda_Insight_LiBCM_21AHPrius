...
//Wait at least ten minutes after keyOff for most accurate results
    ...
    uint8_t SoC_estimateFromRestingCellVoltage_percent(void)
    {
        ...
        //~/Honda_Insight_LiBCM/Electronics/Lithium Batteries/(documentation to be added later, ECKY battery, same table as 21AHPrius)
        if      (restingCellVoltage >= CELL_VREST_100_PERCENT_SoC) { estimatedSoC = 100; }
        ...
        else if (restingCellVoltage >= CELL_VREST_085_PERCENT_SoC) { estimatedSoC =  85; } //Vmax for long lifetime //40450
    ...
    uint8_t SoC_estimateFromRestingCellVoltage_percent(void)
    {
        ...
        //~/Honda_Insight_LiBCM/Electronics/Lithium Batteries/(documentation to be added later)
        if      (restingCellVoltage >= CELL_VREST_100_PERCENT_SoC) { estimatedSoC = 100; }
        else if (restingCellVoltage >= 41850)                      { estimatedSoC =  99; }
        else if (restingCellVoltage >= 41740)                      { estimatedSoC =  98; }
        else if (restingCellVoltage >= 41640)                      { estimatedSoC =  97; }
